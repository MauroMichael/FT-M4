...
describe('Character Routes', () => {
  ...
  describe('Multiple routes', () => {
    ...
    xit('should return status 200 and the list of all characters with certain attributes', async () => {
    ...
    xit('should list all characters that match with the race or the age filters', async () => {
    ...
    xit('should update attribute wich are null with value passed by query', async () => {
      ...
      await request(app).put('/character/age?value=40');
